...
public class AppUtil {
    public static final String COUCHDB_APP_KEY = "couchdb";
    private final File installedAppYaml = new File(ConfigUtils.getAssetPath() + File.separator + "server"
                    + File.separator + "apps" + File.separator + COUCHDB_APP_KEY + ".yml");
    ...
    public void copyAppYml() throws IOException {
        ...
        try (final InputStream in = this.getClass().getResourceAsStream("/" + COUCHDB_APP_KEY + ".yml")) {
