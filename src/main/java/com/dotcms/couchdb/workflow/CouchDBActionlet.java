...
public class CouchDBActionlet extends WorkFlowActionlet {
    ...
    public String getName() {
        return "Sync to CouchDB";
    }

    @Override
    public String getHowTo() {
        return "This actionlet will sync contentlets to the CouchDB database.  It will sync all contentlets of the content types specified in the Content Type List parameter.  It will also sync the contentlets on Publish or Unpublish or AUTO, which means if a content is published, it will be pushed to couch and if it is unpublished, and there are no live versions, it will be removed from couch.";
    }
